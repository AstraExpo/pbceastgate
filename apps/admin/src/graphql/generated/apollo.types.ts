...
export type AuthenticateAdminMutationFn = ApolloReactCommon.MutationFunction<AuthenticateAdminMutation, AuthenticateAdminMutationVariables>;
 ...
 * });
 */
export function useAuthenticateAdminMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<AuthenticateAdminMutation, AuthenticateAdminMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<AuthenticateAdminMutation, AuthenticateAdminMutationVariables>(AuthenticateAdminDocument, options);
      }
export type AuthenticateAdminMutationHookResult = ReturnType<typeof useAuthenticateAdminMutation>;
export type AuthenticateAdminMutationResult = ApolloReactCommon.MutationResult<AuthenticateAdminMutation>;
export type AuthenticateAdminMutationOptions = ApolloReactCommon.BaseMutationOptions<AuthenticateAdminMutation, AuthenticateAdminMutationVariables>;
